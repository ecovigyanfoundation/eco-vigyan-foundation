...
export default function MapPage() {
  ...
  return (
    <div className="flex flex-col min-h-dvh w-screen bg-gray-950 overflow-x-hidden text-white">
      {/* ================= HEADER ================= */}
      <header className="z-[100] bg-gray-900 border-b border-gray-800 shadow-2xl shrink-0 sticky top-0">
        <div className="min-h-[73px] px-4 py-2 flex items-center justify-between gap-3">
          {/* LEFT LOGO */}
          ...
          <div className="hidden md:flex flex-1 max-w-2xl items-center bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden px-4 gap-2">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="md:hidden p-3 rounded-xl bg-gray-800 border border-gray-700"
            >
              <Search size={18} />
            </button>

            {/* ADD OBSERVATION — UNCHANGED */}
            <button
              onClick={() => setShowAddModal(true)}
              className="bg-green-600 hover:bg-green-700 px-4 py-2.5 rounded-xl font-black text-sm flex items-center gap-2 shadow-lg shadow-green-900/40"
            >
              <Plus size={18} />
        ...
        {/* SECOND ROW NAV — UNCHANGED */}
        <div className="h-12 px-4 flex items-center justify-between bg-gray-900/50 border-t border-gray-800/50 overflow-x-auto">
          <nav className="flex h-full">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 h-full border-b-2 text-[10px] font-black uppercase tracking-widest whitespace-nowrap ${
                  view === tab.id
          ...
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-800 border border-gray-700 text-[10px] font-black uppercase">
              <Navigation size={12} className="text-blue-400" /> Trail
            </button>
            <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-800 border border-gray-700 text-[10px] font-black uppercase">
              <Layers size={12} className="text-orange-400" /> Eco Zones
            </button>
          </div>
        </div>
      </header>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {data.map((item, index) => (
                <div
                  ...
                  className="group bg-gray-900 border border-gray-800 rounded-[2rem] p-3 hover:border-green-500 transition-all cursor-pointer"
                >
                  ...
                  <div className="px-2">
                    <h3 className="font-black text-lg group-hover:text-green-400 transition-colors truncate">
                      {item.name}
                    </h3>
                    <p className="text-[10px] font-black text-gray-600 uppercase tracking-widest mt-1">
                      By {item.contributor || "Scientist"}
                    </p>
                  </div>
                </div>
              ))}
      ...
      {showMobileSearch && (
        <div className="fixed inset-0 z-[200] bg-black/70 backdrop-blur-md flex items-start p-4 md:hidden">
          <div className="w-full bg-gray-900 border border-gray-800 rounded-2xl p-4 shadow-2xl animate-in slide-in-from-top-4">
            {/* HEADER */}
          ...
          <div className="bg-gray-800 border border-gray-700 w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl relative">
            ...
            >
              <input
                ...
                className="w-full bg-gray-900 border border-gray-700 rounded-2xl px-5 py-4 focus:ring-2 focus:ring-green-500 outline-none"
                required
              />
              <div className="grid grid-cols-2 gap-4">
                <input
                  name="latitude"
                  placeholder="Lat"
                  className="w-full bg-gray-900 border border-gray-700 rounded-2xl px-5 py-4 outline-none"
                  required
                />
                <input
                  name="longitude"
              ...
              <div className="grid grid-cols-2 gap-4">
                <select
                  name="category"
                  className="w-full bg-gray-900 border border-gray-700 rounded-2xl px-4 py-4 outline-none"
                  required
                >
              ...
              <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-700 rounded-2xl cursor-pointer hover:bg-gray-900 transition-all">
                ...
                <p className="text-[10px] text-gray-500 uppercase font-black">
                  {imageFile ? imageFile.name : "Specimen Photo"}
                </p>
                <input
                  type="file"
                  className="hidden"
              ...
              <button
                ...
                className="w-full bg-green-600 hover:bg-green-500 py-5 rounded-2xl text-white font-black text-lg transition-all active:scale-95 shadow-xl shadow-green-900/40"
              >
